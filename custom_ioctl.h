...
#define MY_IOCTL_CMD_LED_BLINK    _IO(MY_IOCTL_MAGIC, 6)
#define MY_IOCTL_CMD_BTN_CLEAR    _IO(MY_IOCTL_MAGIC, 7)
#define MY_IOCTL_CMD_LED_TIMER      _IO(MY_IOCTL_MAGIC, 8)
